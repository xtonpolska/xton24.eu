...
/**
 * Sekcja hero — carousel na stronie głównej.
 *
 ...
 *
 * Mechanika: natywny scroll-snap (swipe + degradacja bez JS), a moduł
 * `resources/js/modules/hero-carousel.ts` dodaje strzałki, kropki i autoplay.
 *
...
<section class="home-hero" aria-label="<?php esc_attr_e('Wyróżnione oferty', 'xton-shop'); ?>">
    <div class="container">
        <div class="hero-wrap" data-carousel aria-roledescription="carousel">
            <div class="hero-carousel">
                ...
                <?php foreach ($slides as $i => $slide) : ?>
                    <article
                        ...
                        aria-label="<?php echo esc_attr(sprintf(__('%1$d z %2$d', 'xton-shop'), $i + 1, $total)); ?>"
                    >
            ...
            <?php // Kontrolki poza panelem (na jasnym tle strony). ?>
            <div class="hero-controls">
                <div class="hero-controls__dots" data-carousel-dots role="tablist" aria-label="<?php esc_attr_e('Wybór slajdu', 'xton-shop'); ?>"></div>
                <div class="hero-controls__arrows">
                    <button type="button" class="hero-arrow" data-carousel-prev aria-label="<?php esc_attr_e('Poprzedni slajd', 'xton-shop'); ?>">
                        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" width="20" height="20">
                            <path d="M15 19l-7-7 7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </button>
                    <button type="button" class="hero-arrow" data-carousel-next aria-label="<?php esc_attr_e('Następny slajd', 'xton-shop'); ?>">
                        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" width="20" height="20">
